...
// filesystem and uploads them as a zip archive to remote storage. This
// captures the MANIFEST, OPTIONS, format-version marker, manifest marker, and
// remote object catalog — everything needed to reopen the DB with its remote
// SSTables.
...
func ManifestBundleExists(
	ctx context.Context, store remote.Storage, storeID int32,
) (bool, error) {
