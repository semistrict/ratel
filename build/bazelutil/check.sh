...
pkg/cmd/roachtest/tests/drt.go://go:generate mockgen -package tests -destination drt_generated_test.go github.com/semistrict/ratel/pkg/cmd/roachtest/prometheus Client
...
# the same thing: https://github.com/semistrict/ratel/issues/64440
