...
different CockroachDB nodes, the [`FlowStream` RPC](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfrapb/api.proto#L163-L173)
...
Each outbox runs in a separate goroutine that is instantiated on the [flow setup](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/flow.go#L396-L398).
...
the wait group of the flow (the setup is done in [`StartInternal`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/flow.go#L382)).
These goroutines first wait for the flow (that contains their reader) to arrive
in [`ConnectInboundStream`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql/server.go#L660-L662)
...
[`flowinfra.InboundStreamHandler.Run`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L32)
...
the [`Run` method](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql/server.go#L666).
...
- on the gateway node there is a flow coordinator ([`FlowCoordinator`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/flow_coordinator.go#L31)
or [`BatchFlowCoordinator`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/flow_coordinator.go#L184))
which cancels the flow context ([1](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/flow_coordinator.go#L159),
[2](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/flow_coordinator.go#L332))
...
the gateway node. In such case, each outbox [cancels](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/outbox.go#L236-L239)
its own "outbox" context which terminates all of the components (including each
input goroutine of the [parallel unordered synchronizer](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colexec/parallel_unordered_synchronizer.go#L319-L321))
...
that sit on top of [`routerOutputOp`s](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/routers.go#L103)
...
The main goroutine of the outbox is tracked by the wait group of the [flow](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/vectorized_flow.go#L1260-L1268).
It first establishes the connection to the target node and calls `FlowStream`
RPC, importantly, [using the flow context](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/outbox.go#L192).
...
Once the gRPC stream is established, another "watchdog" goroutine is [spun up](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/outbox.go#L382).
...
Then the main goroutine goes into [`sendBatches`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/outbox.go#L271)
...
[`DrainMeta`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/outbox.go#L349)
...
The stream handler goroutine non-blockingly [passes](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L229)
...
[sending its context](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L311)).
- then it waits for the reader to exit (by [closing the inbox](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L204)).
...
it exits with the corresponding error ([here](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L237-L243)
and [here](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L253-L266)).
...
of the reader context) being canceled, the flow context is [explicitly checked](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L263)
...
synchronizer, then it'll be a separate input goroutine [created by](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colexec/parallel_unordered_synchronizer.go#L214)
...
non-`io.EOF` errors are marked as ["inbox communication errors"](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L364).
Such errors are propagated both to the [consumer of the inbox](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L366)
and to the [stream handler](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L365)
goroutine (so they become the result of `FlowStream` RPC).
- an error is received from the outbox [as metadata](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L374)
or is encountered internally ([here](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L408)
and [here](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L415))
by the inbox. Such errors are propagated to the [consumer of the inbox](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L343),
...
`statement_timeout` in CockroachDB is implemented by setting up a [timer](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/conn_executor_exec.go#L471-L477)
which upon firing cancels the query. The query cancellation is done by
[canceling](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/exec_util.go#L1781)
...
to mention the abstractions that the engine is using, namely [`RowSource`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L109)
and [`RowReceiver`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L64)
interfaces. The `RowSource` on [`Next`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L146)
...
[`ConsumerStatus`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L41-L51).

Essentially all [`Processor`s](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L36)
implement the `RowSource` interface, and we use different components to connect
the processors together (routers, [`RowChannel`s](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L431),
...
Most processors delegate the implementation of [`Processor.Run`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L47)
method to the embedded [`ProcessorBase`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L728)
which `Start`s itself and then goes into the [`Run`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L184)
...
At the root of the flow on the gateway we have a special [`DistSQLReceiver`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql_running.go#L584)
guy that implements the `RowReceiver` interface, and it is where the results of
the query are ultimately `Push`ed into. The gateway flow is being [`Run`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/flow.go#L104)
which means starting all processors except for the last one in separate
goroutines and running the "root" processor in the [flow's goroutine](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/flow.go#L453).
...
from [`StateRunning`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L464)
to [`StateDraining`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L492)
by calling [`MoveToDraining`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L514).
That function notifies the processor's input that it should be drained (by
calling `ConsumerDone`), and then the processor is using [`DrainHelper`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L549)
...
[`InternalClose`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L904)).
...
the `ConsumerStatus` in that [`Run`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L184)
...
[`ProcessorBase.ProcessRowHelper`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/processorsbase.go#L707)).
...
[`DistSQLReceiver`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql_running.go#L949).
The `DistSQLReceiver` then [transitions](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql_running.go#L906)
...
`DistSQLReceiver` will still transition to draining first in [`SetError`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql_running.go#L897)
because the `DistSQLReceiver`'s `ctx` is the transaction context, and it hasn't
been canceled.

### Outbox Details

The main goroutine of the outbox is tracked by the wait group of the [flow](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L418-L441).
It first establishes the connection to the target node and, unlike in the
vectorized case, it [uses `context.TODO`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L237)
to perform the `FlowStream` RPC. TODO(yuzefovich): investigate whether we can
use the flow context here too.

Next, a separate "watchdog" goroutine is spun up [using the stopper](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L377)
...
Tha main goroutine goes into the [loop](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L276)
where it reads from the input (either a processor or a router) and writes to the
gRPC stream. Rows and metadata are encoded in [`AddRow`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L121)
into messages which are [`flushed`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L156)
to the consumer once [16 rows](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L34)
have been accumulated or [100 microseconds](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L35)
have passed since the last flush, the exception is only made to [errors](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L130)
...
closure of the embedded [`RowChannel`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L279).
...
`AddRow` for metadata objects after calling [`ConsumerDone` on its input](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L344)).
As a reminder, `ProducerDone` is always called at the end of the [`Run` loop](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L184)
of the processor.
- an error is encountered when [`AddRow` is called](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L308)
...
- the "watchdog" goroutine `Recv`es an error from the gRPC stream
  - if it is `io.EOF`, then the main goroutine exits [gracefully](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L348).
  - if it is non-`io.EOF`, then the main goroutine cancels the context of the
    flow and exits [ungracefully](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L338).

`ConsumerClosed` is [always](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/outbox.go#L208)
...
[creates](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L133)
the "reader" goroutine and then proceeds to [block](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L163-L168)
...
The "reader" goroutine is tracked by the wait group of the [flow](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L132-L134),
and it keeps on [`Recv`ing](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L136)
...
Additionally, non-`io.EOF` errors are marked as ["inbox communication errors"](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L140).
The received messages are [decoded](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L217)
and then [pushed](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L236)
to the consumer of this inbound stream. If that consumer asks for draining, then
the drain signal is [sent](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/flowinfra/inbound.go#L246)
on the gRPC stream.
...
[operates with](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql_running.go#L585).
...
[cancellation](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql_running.go#L1039-L1041).
The `ConsumerStatus` is [changed](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/distsql_running.go#L903)
...
execution. For example, this includes a [progress update](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/rowexec/sampler.go#L269-L271)
...
For example, this includes [`LeafTxnFinalState`](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L292)
...
method](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/execinfra/base.go#L146)
...
propagated as metadata which are not buffered and are [thrown](https://github.com/semistrict/ratel/blob/daf29fd72896e46c1c40ddc5b62e504a8ee77b68/pkg/sql/colflow/colrpc/inbox.go#L378)
immediately.
