...
import (
	...
	github_com_semistrict_ratel_pkg_kv_kvserver_closedts_ctpb "github.com/semistrict/ratel/pkg/kv/kvserver/closedts/ctpb"
...
type RangeSideTransportInfo struct {
	...
	ReplicaLAI    github_com_semistrict_ratel_pkg_kv_kvserver_closedts_ctpb.LAI `protobuf:"varint,2,opt,name=replica_lai,json=replicaLai,proto3,casttype=github.com/semistrict/ratel/pkg/kv/kvserver/closedts/ctpb.LAI" json:"replica_lai,omitempty"`
	CentralClosed hlc.Timestamp                                                 `protobuf:"bytes,3,opt,name=central_closed,json=centralClosed,proto3" json:"central_closed"`
	CentralLAI    github_com_semistrict_ratel_pkg_kv_kvserver_closedts_ctpb.LAI `protobuf:"varint,4,opt,name=central_lai,json=centralLai,proto3,casttype=github.com/semistrict/ratel/pkg/kv/kvserver/closedts/ctpb.LAI" json:"central_lai,omitempty"`
}
...
var fileDescriptor_cc107fbd3ff296cb = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReplicaLAI |= github_com_semistrict_ratel_pkg_kv_kvserver_closedts_ctpb.LAI(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.CentralLAI |= github_com_semistrict_ratel_pkg_kv_kvserver_closedts_ctpb.LAI(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
