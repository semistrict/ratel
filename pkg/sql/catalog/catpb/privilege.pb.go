...
type UserPrivileges struct {
	UserProto github_com_semistrict_ratel_pkg_security.SQLUsernameProto `protobuf:"bytes,1,opt,name=user_proto,json=userProto,casttype=github.com/semistrict/ratel/pkg/security.SQLUsernameProto" json:"user_proto"`
...
type PrivilegeDescriptor struct {
	...
	OwnerProto github_com_semistrict_ratel_pkg_security.SQLUsernameProto `protobuf:"bytes,2,opt,name=owner_proto,json=ownerProto,casttype=github.com/semistrict/ratel/pkg/security.SQLUsernameProto" json:"owner_proto"`
...
type DefaultPrivilegesForRole struct {
	...
	DefaultPrivilegesPerObject map[github_com_semistrict_ratel_pkg_sql_sem_tree.AlterDefaultPrivilegesTargetObject]PrivilegeDescriptor `protobuf:"bytes,14,rep,name=default_privileges_per_object,json=defaultPrivilegesPerObject,castkey=github.com/semistrict/ratel/pkg/sql/sem/tree.AlterDefaultPrivilegesTargetObject" json:"default_privileges_per_object" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func init() {
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_sql_sem_tree.AlterDefaultPrivilegesTargetObject]PrivilegeDescriptor)(nil), "cockroach.sql.sqlbase.DefaultPrivilegesForRole.DefaultPrivilegesPerObjectEntry")
...
var fileDescriptor_38674e6995c4b96a = []byte{
	...
	,
}
...
func (m *DefaultPrivilegesForRole) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DefaultPrivilegesPerObject) > 0 {
		...
		for iNdEx := len(keysForDefaultPrivilegesPerObject) - 1; iNdEx >= 0; iNdEx-- {
			v := m.DefaultPrivilegesPerObject[github_com_semistrict_ratel_pkg_sql_sem_tree.AlterDefaultPrivilegesTargetObject(keysForDefaultPrivilegesPerObject[iNdEx])]
			baseI := i
			{
...
func (m *PrivilegeDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.OwnerProto = github_com_semistrict_ratel_pkg_security.SQLUsernameProto(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
	...
	for iNdEx < l {
		...
		case 14:
			...
			if m.DefaultPrivilegesPerObject == nil {
				m.DefaultPrivilegesPerObject = make(map[github_com_semistrict_ratel_pkg_sql_sem_tree.AlterDefaultPrivilegesTargetObject]PrivilegeDescriptor)
			}
			var mapkey uint32
			...
			m.DefaultPrivilegesPerObject[github_com_semistrict_ratel_pkg_sql_sem_tree.AlterDefaultPrivilegesTargetObject(mapkey)] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipPrivilege(dAtA[iNdEx:])
