...
func scanFetchSpecHasSubordinateColumns(spec fetchpb.IndexFetchSpec) bool {
...
func defaultScanBatchBytesLimit(spec fetchpb.IndexFetchSpec) rowinfra.BytesLimit {
	if scanFetchSpecHasSubordinateColumns(spec) {
		return subordinateScanBatchBytesLimit
	}
	return rowinfra.GetDefaultBatchBytesLimit(false /* forceProductionValue */)
}
