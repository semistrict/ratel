...
type SampleAggregatorSpec struct {
	...
	SampledColumnIDs []github_com_semistrict_ratel_pkg_sql_catalog_descpb.ColumnID `protobuf:"varint,3,rep,name=sampled_column_ids,json=sampledColumnIds,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ColumnID" json:"sampled_column_ids,omitempty"`
	TableID          github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID         `protobuf:"varint,4,opt,name=table_id,json=tableId,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"table_id"`
	// JobID is the id of the CREATE STATISTICS job.
	JobID github_com_semistrict_ratel_pkg_jobs_jobspb.JobID `protobuf:"varint,6,opt,name=job_id,json=jobId,casttype=github.com/semistrict/ratel/pkg/jobs/jobspb.JobID" json:"job_id"`
...
var fileDescriptor_d08bfa18785ff29a = []byte{
	...
	,
}
		...
		case 3:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.SampledColumnIDs) == 0 {
					m.SampledColumnIDs = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.ColumnID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.ColumnID
					for shift := uint(0); ; shift += 7 {
