...
```
go/src/github.com/semistrict/ratel $ ./build/builder.sh mkrelease linux-gnu
go/src/github.com/semistrict/ratel $ cp ./cockroach-linux-2.6.32-gnu-amd64 build/deploy/cockroach
go/src/github.com/semistrict/ratel $ cp ./lib.docker_amd64/libgeos_c.so ./lib.docker_amd64/libgeos.so build/deploy/
go/src/github.com/semistrict/ratel $ cp -r licenses build/deploy/
go/src/github.com/semistrict/ratel $ cd build/deploy && docker build -t cockroachdb/cockroach .
```
