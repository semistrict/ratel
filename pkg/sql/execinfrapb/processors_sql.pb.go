...
type TableReaderSpec struct {
	...
	// json_contains_filter, when set, evaluates a filter of the form
	//   json_col @> <right>
	//   json_col <@ <right>
	//   json_col->... @> <right>
	// directly from recursive subordinate JSON storage during row scanning.
	JsonContainsFilter *JSONContainsFilterSpec `protobuf:"bytes,26,opt,name=json_contains_filter,json=jsonContainsFilter" json:"json_contains_filter,omitempty"`
}
...
var fileDescriptor_90493aed97b6d28f = []byte{
	...
	,
	...
	,
}
...
func (m *TableReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.JsonContainsFilter != nil {
		{
			size, err := m.JsonContainsFilter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *JoinReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		dAtA17 := make([]byte, len(m.LookupColumns)*10)
		var j16 int
...
func (m *ZigzagJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IndexOrdinals) > 0 {
		dAtA22 := make([]byte, len(m.IndexOrdinals)*10)
		var j21 int
...
func (m *InvertedJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrefixEqualityColumns) > 0 {
		dAtA32 := make([]byte, len(m.PrefixEqualityColumns)*10)
		var j31 int
...
func (m *AggregatorSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.GroupCols) > 0 {
		dAtA44 := make([]byte, len(m.GroupCols)*10)
		var j43 int
		...
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j43))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *TableReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JsonContainsFilter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.JsonContainsFilter == nil {
				m.JsonContainsFilter = &JSONContainsFilterSpec{}
			}
			if err := m.JsonContainsFilter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
