...
type SessionData struct {
	...
	UserProto github_com_cockroachdb_cockroach_pkg_security.SQLUsernameProto `protobuf:"bytes,3,opt,name=user_proto,json=userProto,proto3,casttype=github.com/semistrict/ratel/pkg/security.SQLUsernameProto" json:"user_proto,omitempty"`
