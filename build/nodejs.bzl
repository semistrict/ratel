load("@bazel_lib//lib/private:copy_directory_toolchain.bzl", "copy_directory_toolchains_repo")
load("@bazel_lib//lib/private:copy_to_directory_toolchain.bzl", "copy_to_directory_toolchains_repo")
load("@aspect_bazel_lib//lib/private:copy_directory_toolchain.bzl", legacy_copy_directory_toolchains_repo = "copy_directory_toolchains_repo")
load("@aspect_bazel_lib//lib/private:copy_to_directory_toolchain.bzl", legacy_copy_to_directory_toolchains_repo = "copy_to_directory_toolchains_repo")
...
def declare_nodejs_repos():
    ...
    legacy_copy_directory_toolchains_repo(
        name = "copy_directory_toolchains_legacy",
        user_repository_name = "copy_directory",
    )
    legacy_copy_to_directory_toolchains_repo(
        name = "copy_to_directory_toolchains_legacy",
        user_repository_name = "copy_to_directory",
    )
