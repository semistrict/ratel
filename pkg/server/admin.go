...
import (
	...
	"github.com/semistrict/ratel/pkg/ts/catalog"
	...
	"github.com/semistrict/ratel/pkg/util/tracing/tracingui"
...
func (s *adminServer) checkReadinessForHealthCheck(ctx context.Context) error {
	...
	// https://github.com/semistrict/ratel/issues/45123
...
func (s *adminServer) decommissionStatusHelper(
	...
	livenessMap := map[roachpb.NodeID]livenesspb.Liveness{}
	{
		...
		// For an example, see:
		//
		// https://github.com/semistrict/ratel/issues/73636
