...
func generateTestSuites() {
	...
	goLabels = excludeReallyEnormousTargets(goLabels)
	testLabels = excludeReallyEnormousTargets(testLabels)
...
func excludeReallyEnormousTargets(targets []string) []string {
	for i := 0; i < len(targets); i++ {
		...
		for _, toExclude := range []string{
			...
			"//pkg/cli/clisqlshell",
			"//pkg/cloud/userfile",
			"//pkg/cloud/userfile/filetable/filetabletest",
			"//pkg/cmd/roachtest",
			"//pkg/cmd/ratel",
			"//pkg/configprofiles",
			...
			"//pkg/sql/logictest/tests/5node-disk",
			"//pkg/sql/logictest/tests/cockroach-go-testserver-upgrade-to-master",
			"//pkg/sql/logictest/tests/fakedist",
			"//pkg/sql/logictest/tests/fakedist-disk",
			"//pkg/sql/logictest/tests/fakedist-vec-off",
			"//pkg/sql/logictest/tests/local",
			"//pkg/sql/logictest/tests/local-legacy-schema-changer",
			"//pkg/sql/logictest/tests/local-mixed-22.2-23.1",
			"//pkg/sql/logictest/tests/local-vec-off",
			"//pkg/sql/logictest/tests/multiregion",
			"//pkg/sql/opt/exec/execbuilder/tests/5node",
			"//pkg/sql/opt/exec/execbuilder/tests/fakedist",
			"//pkg/sql/opt/exec/execbuilder/tests/fakedist-disk",
			"//pkg/sql/opt/exec/execbuilder/tests/fakedist-vec-off",
			"//pkg/sql/opt/exec/execbuilder/tests/local",
			"//pkg/sql/opt/exec/execbuilder/tests/local-legacy-schema-changer",
			"//pkg/sql/opt/exec/execbuilder/tests/local-vec-off",
			...
			"//pkg/sql/sqlstats/insights/integration",
