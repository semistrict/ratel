...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{18, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{18, 1}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{20, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{20, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{20, 1, 1}
}
...
func (WindowerSpec_Frame_Exclusion) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{20, 1, 2}
}
...
type ArrayEqualsAnyFilterSpec struct {
	// array_col_idx is the ordinal of the array column within
	// TableReaderSpec.fetch_spec.fetched_columns.
	ArrayColIdx uint32 `protobuf:"varint,1,opt,name=array_col_idx,json=arrayColIdx" json:"array_col_idx"`
	// left is a row-independent scalar expression to compare against array
	// elements. It must not reference scan columns.
	Left Expression `protobuf:"bytes,2,opt,name=left" json:"left"`
}

func (m *ArrayEqualsAnyFilterSpec) Reset()         { *m = ArrayEqualsAnyFilterSpec{} }
func (m *ArrayEqualsAnyFilterSpec) String() string { return proto.CompactTextString(m) }
func (*ArrayEqualsAnyFilterSpec) ProtoMessage()    {}
func (*ArrayEqualsAnyFilterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{1}
}
func (m *ArrayEqualsAnyFilterSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ArrayEqualsAnyFilterSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *ArrayEqualsAnyFilterSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ArrayEqualsAnyFilterSpec.Merge(m, src)
}
func (m *ArrayEqualsAnyFilterSpec) XXX_Size() int {
	return m.Size()
}
func (m *ArrayEqualsAnyFilterSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_ArrayEqualsAnyFilterSpec.DiscardUnknown(m)
}

var xxx_messageInfo_ArrayEqualsAnyFilterSpec proto.InternalMessageInfo

type JSONExistsFilterSpec struct {
	// source_col_idx is the ordinal of the source JSON column within
	// TableReaderSpec.fetch_spec.fetched_columns.
	SourceColIdx uint32 `protobuf:"varint,1,opt,name=source_col_idx,json=sourceColIdx" json:"source_col_idx"`
	// kind is a row.JSONAccessKind value for ?, ?|, and ?&.
...
func (m *JSONExistsFilterSpec) Reset()         { *m = JSONExistsFilterSpec{} }
func (m *JSONExistsFilterSpec) String() string { return proto.CompactTextString(m) }
func (*JSONExistsFilterSpec) ProtoMessage()    {}
func (*JSONExistsFilterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{2}
}
func (m *JSONExistsFilterSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JSONExistsFilterSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *JSONExistsFilterSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JSONExistsFilterSpec.Merge(m, src)
}
func (m *JSONExistsFilterSpec) XXX_Size() int {
	return m.Size()
}
func (m *JSONExistsFilterSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_JSONExistsFilterSpec.DiscardUnknown(m)
}

var xxx_messageInfo_JSONExistsFilterSpec proto.InternalMessageInfo

type JSONAccessSpec struct {
	// source_col_idx is the ordinal of the source JSON column within
	// TableReaderSpec.fetch_spec.fetched_columns.
	SourceColIdx uint32 `protobuf:"varint,1,opt,name=source_col_idx,json=sourceColIdx" json:"source_col_idx"`
	// kind is a row.JSONAccessKind value.
	Kind uint32 `protobuf:"varint,2,opt,name=kind" json:"kind"`
	// key is used by JSONAccessExists.
	Key string `protobuf:"bytes,3,opt,name=key" json:"key"`
	// keys is used by JSONAccessExistsAny / JSONAccessExistsAll.
	...
	// materialize keeps the source JSON column materialized in the row if true.
	Materialize bool `protobuf:"varint,6,opt,name=materialize" json:"materialize"`
}

func (m *JSONAccessSpec) Reset()         { *m = JSONAccessSpec{} }
func (m *JSONAccessSpec) String() string { return proto.CompactTextString(m) }
func (*JSONAccessSpec) ProtoMessage()    {}
func (*JSONAccessSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{3}
}
func (m *JSONAccessSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JSONAccessSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *JSONAccessSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JSONAccessSpec.Merge(m, src)
}
func (m *JSONAccessSpec) XXX_Size() int {
	return m.Size()
}
func (m *JSONAccessSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_JSONAccessSpec.DiscardUnknown(m)
}

var xxx_messageInfo_JSONAccessSpec proto.InternalMessageInfo

type JSONPathCompareFilterSpec struct {
	// source_col_idx is the ordinal of the source JSON column within
	// TableReaderSpec.fetch_spec.fetched_columns.
	SourceColIdx uint32 `protobuf:"varint,1,opt,name=source_col_idx,json=sourceColIdx" json:"source_col_idx"`
	// kind is a row.JSONAccessKind value for fetch-path operations.
	Kind uint32 `protobuf:"varint,2,opt,name=kind" json:"kind"`
	// path is used by JSONAccessFetchJSONPath / JSONAccessFetchTextPath.
	Path []string `protobuf:"bytes,3,rep,name=path" json:"path,omitempty"`
	// mode is an exec.JSONPathFilterMode value.
	Mode uint32 `protobuf:"varint,4,opt,name=mode" json:"mode"`
	// right is a row-independent scalar expression to compare against the
	// fetched JSON path result.
	Right Expression `protobuf:"bytes,5,opt,name=right" json:"right"`
}

func (m *JSONPathCompareFilterSpec) Reset()         { *m = JSONPathCompareFilterSpec{} }
func (m *JSONPathCompareFilterSpec) String() string { return proto.CompactTextString(m) }
func (*JSONPathCompareFilterSpec) ProtoMessage()    {}
func (*JSONPathCompareFilterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{4}
}
func (m *JSONPathCompareFilterSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JSONPathCompareFilterSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *JSONPathCompareFilterSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JSONPathCompareFilterSpec.Merge(m, src)
}
func (m *JSONPathCompareFilterSpec) XXX_Size() int {
	return m.Size()
}
func (m *JSONPathCompareFilterSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_JSONPathCompareFilterSpec.DiscardUnknown(m)
}

var xxx_messageInfo_JSONPathCompareFilterSpec proto.InternalMessageInfo

type JSONContainsFilterSpec struct {
	// source_col_idx is the ordinal of the source JSON column within
	// TableReaderSpec.fetch_spec.fetched_columns.
	SourceColIdx uint32 `protobuf:"varint,1,opt,name=source_col_idx,json=sourceColIdx" json:"source_col_idx"`
	// kind is a row.JSONAccessKind value for fetch-json-path operations.
	Kind uint32 `protobuf:"varint,2,opt,name=kind" json:"kind"`
	// path is used by JSONAccessFetchJSONPath.
	Path []string `protobuf:"bytes,3,rep,name=path" json:"path,omitempty"`
	// contained_by indicates whether the predicate is <@ instead of @>.
	ContainedBy bool `protobuf:"varint,4,opt,name=contained_by,json=containedBy" json:"contained_by"`
	// right is a row-independent JSON expression to compare against the
	// accessed JSON subtree.
	Right Expression `protobuf:"bytes,5,opt,name=right" json:"right"`
}

func (m *JSONContainsFilterSpec) Reset()         { *m = JSONContainsFilterSpec{} }
func (m *JSONContainsFilterSpec) String() string { return proto.CompactTextString(m) }
func (*JSONContainsFilterSpec) ProtoMessage()    {}
func (*JSONContainsFilterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{5}
}
func (m *JSONContainsFilterSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *JSONContainsFilterSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *JSONContainsFilterSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_JSONContainsFilterSpec.Merge(m, src)
}
func (m *JSONContainsFilterSpec) XXX_Size() int {
	return m.Size()
}
func (m *JSONContainsFilterSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_JSONContainsFilterSpec.DiscardUnknown(m)
}

var xxx_messageInfo_JSONContainsFilterSpec proto.InternalMessageInfo
...
type TableReaderSpec struct {
	...
	// array_equals_any_filter, when set, evaluates
	//   left = ANY(array_col)
	// during row scanning. The array column may be fetched as an internal-only
	// column and projected away by the table reader's PostProcessSpec.
	ArrayEqualsAnyFilter *ArrayEqualsAnyFilterSpec `protobuf:"bytes,22,opt,name=array_equals_any_filter,json=arrayEqualsAnyFilter" json:"array_equals_any_filter,omitempty"`
	// json_exists_filter, when set, evaluates a filter of the form
	//   json_col ? 'key'
	// directly from recursive subordinate JSON storage during row scanning.
	JsonExistsFilter *JSONExistsFilterSpec `protobuf:"bytes,23,opt,name=json_exists_filter,json=jsonExistsFilter" json:"json_exists_filter,omitempty"`
	// json_accesses, when set, compute derived values directly from recursive
	// subordinate JSON storage during row scanning. Source JSON columns may be
	// fetched as internal-only columns and projected away by the table reader's
	// PostProcessSpec.
	JsonAccesses []JSONAccessSpec `protobuf:"bytes,24,rep,name=json_accesses,json=jsonAccesses" json:"json_accesses"`
	// json_path_compare_filter, when set, evaluates a filter of the form
	//   json_col->... = <right>
	// directly from recursive subordinate JSON storage during row scanning.
	JsonPathCompareFilter *JSONPathCompareFilterSpec `protobuf:"bytes,25,opt,name=json_path_compare_filter,json=jsonPathCompareFilter" json:"json_path_compare_filter,omitempty"`
	// json_contains_filters, when set, evaluate filters of the form
	//   json_col @> <right>
	//   json_col <@ <right>
	//   json_col->... @> <right>
	// directly from recursive subordinate JSON storage during row scanning.
	JsonContainsFilters []JSONContainsFilterSpec `protobuf:"bytes,26,rep,name=json_contains_filters,json=jsonContainsFilters" json:"json_contains_filters"`
}
...
func (*InvertedFiltererSpec_PreFiltererSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{17, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{19}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{20}
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{20, 1}
}
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_90493aed97b6d28f, []int{20, 2}
}
...
func init() {
	...
	proto.RegisterType((*ArrayEqualsAnyFilterSpec)(nil), "cockroach.sql.distsqlrun.ArrayEqualsAnyFilterSpec")
	proto.RegisterType((*JSONExistsFilterSpec)(nil), "cockroach.sql.distsqlrun.JSONExistsFilterSpec")
	proto.RegisterType((*JSONAccessSpec)(nil), "cockroach.sql.distsqlrun.JSONAccessSpec")
	proto.RegisterType((*JSONPathCompareFilterSpec)(nil), "cockroach.sql.distsqlrun.JSONPathCompareFilterSpec")
	proto.RegisterType((*JSONContainsFilterSpec)(nil), "cockroach.sql.distsqlrun.JSONContainsFilterSpec")
...
var fileDescriptor_90493aed97b6d28f = []byte{
	...
	,
}
...
func (m *ArrayEqualsAnyFilterSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *ArrayEqualsAnyFilterSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *ArrayEqualsAnyFilterSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	i--
	dAtA[i] = 0x12
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.ArrayColIdx))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}

func (m *JSONExistsFilterSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JSONExistsFilterSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JSONExistsFilterSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.Keys) > 0 {
		for iNdEx := len(m.Keys) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProcessorsSql(dAtA, i, uint64(len(m.Keys[iNdEx])))
			i--
			dAtA[i] = 0x22
		}
	}
	i -= len(m.Key)
	copy(dAtA[i:], m.Key)
	i = encodeVarintProcessorsSql(dAtA, i, uint64(len(m.Key)))
	i--
	dAtA[i] = 0x1a
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.Kind))
	i--
	dAtA[i] = 0x10
	i = encodeVarintProcessorsSql(dAtA, i, uint64(m.SourceColIdx))
	i--
	dAtA[i] = 0x8
	return len(dAtA) - i, nil
}

func (m *JSONAccessSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JSONAccessSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JSONAccessSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.Path) > 0 {
		for iNdEx := len(m.Path) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = encodeVarintProcessorsSql(dAtA, i, uint64(len(m.Path[iNdEx])))
			i--
			dAtA[i] = 0x2a
		}
	}
...
func (m *JSONPathCompareFilterSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JSONPathCompareFilterSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JSONPathCompareFilterSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *JSONContainsFilterSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *JSONContainsFilterSpec) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *JSONContainsFilterSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TableReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.JsonContainsFilters) > 0 {
		for iNdEx := len(m.JsonContainsFilters) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.JsonContainsFilters[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.JsonPathCompareFilter != nil {
		{
			size, err := m.JsonPathCompareFilter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if len(m.JsonAccesses) > 0 {
		for iNdEx := len(m.JsonAccesses) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.JsonAccesses[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.JsonExistsFilter != nil {
		{
			size, err := m.JsonExistsFilter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.ArrayEqualsAnyFilter != nil {
		{
			size, err := m.ArrayEqualsAnyFilter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *JoinReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		dAtA16 := make([]byte, len(m.LookupColumns)*10)
		var j15 int
...
func (m *ZigzagJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IndexOrdinals) > 0 {
		dAtA21 := make([]byte, len(m.IndexOrdinals)*10)
		var j20 int
...
func (m *InvertedJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.PrefixEqualityColumns) > 0 {
		dAtA31 := make([]byte, len(m.PrefixEqualityColumns)*10)
		var j30 int
...
func (m *AggregatorSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OrderedGroupCols) > 0 {
		...
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j40))
		i--
		dAtA[i] = 0x22
	}
	...
	if len(m.GroupCols) > 0 {
		dAtA43 := make([]byte, len(m.GroupCols)*10)
		var j42 int
		...
		i = encodeVarintProcessorsSql(dAtA, i, uint64(j42))
		i--
		dAtA[i] = 0x12
	}
	return len(dAtA) - i, nil
...
func (m *ArrayEqualsAnyFilterSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovProcessorsSql(uint64(m.ArrayColIdx))
	l = m.Left.Size()
	n += 1 + l + sovProcessorsSql(uint64(l))
	return n
}

func (m *JSONExistsFilterSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	n += 1 + sovProcessorsSql(uint64(m.SourceColIdx))
	n += 1 + sovProcessorsSql(uint64(m.Kind))
	l = len(m.Key)
	n += 1 + l + sovProcessorsSql(uint64(l))
	if len(m.Keys) > 0 {
...
func (m *JSONAccessSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JSONPathCompareFilterSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *JSONContainsFilterSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TableReaderSpec) Size() (n int) {
	...
	n += 2 + l + sovProcessorsSql(uint64(l))
	if m.ArrayEqualsAnyFilter != nil {
		l = m.ArrayEqualsAnyFilter.Size()
		n += 2 + l + sovProcessorsSql(uint64(l))
	}
	if m.JsonExistsFilter != nil {
		l = m.JsonExistsFilter.Size()
		n += 2 + l + sovProcessorsSql(uint64(l))
	}
	if len(m.JsonAccesses) > 0 {
		for _, e := range m.JsonAccesses {
			l = e.Size()
			n += 2 + l + sovProcessorsSql(uint64(l))
		}
	}
	if m.JsonPathCompareFilter != nil {
		l = m.JsonPathCompareFilter.Size()
		n += 2 + l + sovProcessorsSql(uint64(l))
	}
	if len(m.JsonContainsFilters) > 0 {
		for _, e := range m.JsonContainsFilters {
			l = e.Size()
			n += 2 + l + sovProcessorsSql(uint64(l))
		}
	}
...
func (m *ArrayEqualsAnyFilterSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ArrayEqualsAnyFilterSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ArrayEqualsAnyFilterSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ArrayColIdx", wireType)
			}
			m.ArrayColIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ArrayColIdx |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *JSONExistsFilterSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JSONExistsFilterSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JSONExistsFilterSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SourceColIdx", wireType)
			}
			m.SourceColIdx = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SourceColIdx |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *JSONAccessSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JSONAccessSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JSONAccessSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *JSONPathCompareFilterSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JSONPathCompareFilterSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JSONPathCompareFilterSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
...
func (m *JSONContainsFilterSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: JSONContainsFilterSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: JSONContainsFilterSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ContainedBy", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func (m *TableReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ArrayEqualsAnyFilter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ArrayEqualsAnyFilter == nil {
				m.ArrayEqualsAnyFilter = &ArrayEqualsAnyFilterSpec{}
			}
			if err := m.ArrayEqualsAnyFilter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JsonExistsFilter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.JsonExistsFilter == nil {
				m.JsonExistsFilter = &JSONExistsFilterSpec{}
			}
			if err := m.JsonExistsFilter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 24:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JsonAccesses", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.JsonAccesses = append(m.JsonAccesses, JSONAccessSpec{})
			if err := m.JsonAccesses[len(m.JsonAccesses)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 25:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JsonPathCompareFilter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.JsonPathCompareFilter == nil {
				m.JsonPathCompareFilter = &JSONPathCompareFilterSpec{}
			}
			if err := m.JsonPathCompareFilter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 26:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field JsonContainsFilters", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.JsonContainsFilters = append(m.JsonContainsFilters, JSONContainsFilterSpec{})
			if err := m.JsonContainsFilters[len(m.JsonContainsFilters)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
