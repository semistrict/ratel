...
func evalConstDatum(evalCtx *tree.EvalContext, expr tree.TypedExpr) (tree.Datum, bool, error) {
...
func extractJSONStringKeyFromTypedExpr(
	evalCtx *tree.EvalContext, expr tree.TypedExpr,
) (string, bool, error) {
...
func extractJSONSourceAndPathFromTypedExpr(
	evalCtx *tree.EvalContext, sourceCols []catalog.Column, expr tree.TypedExpr,
...
func extractJSONPathCompareFilterFromTypedExpr(
	...
	for _, c := range candidates {
		...
		rightExpr, err := physicalplan.MakeExpression(c.right, exprCtx, nil /* indexVarMap */)
		if err != nil {
			return nil, false, err
		}
