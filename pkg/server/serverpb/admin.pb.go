...
import (
	...
	catalog "github.com/semistrict/ratel/pkg/ts/catalog"
	metric "github.com/semistrict/ratel/pkg/util/metric"
...
type DatabaseDetailsResponse_Stats struct {
	...
	NodeIDs []github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,4,rep,packed,name=node_ids,json=nodeIds,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"node_ids,omitempty"`
}
...
type TableStatsResponse struct {
	...
	NodeIDs []github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,7,rep,packed,name=node_ids,json=nodeIds,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"node_ids,omitempty"`
}
...
type DecommissionStatusRequest struct {
	NodeIDs []github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,1,rep,packed,name=node_ids,json=nodeIds,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"node_ids,omitempty"`
...
type DecommissionStatusResponse_Replica struct {
	ReplicaID github_com_semistrict_ratel_pkg_roachpb.ReplicaID `protobuf:"varint,1,opt,name=replica_id,json=replicaId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.ReplicaID" json:"replica_id,omitempty"`
	RangeID   github_com_semistrict_ratel_pkg_roachpb.RangeID   `protobuf:"varint,2,opt,name=range_id,json=rangeId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.RangeID" json:"range_id,omitempty"`
}
...
type LivenessResponse struct {
	...
	Statuses   map[github_com_semistrict_ratel_pkg_roachpb.NodeID]livenesspb.NodeLivenessStatus `protobuf:"bytes,2,rep,name=statuses,proto3,castkey=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"statuses" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3,enum=cockroach.kv.kvserver.liveness.livenesspb.NodeLivenessStatus"`
}
...
type JobResponse struct {
	...
	DescriptorIDs     []github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,5,rep,packed,name=descriptor_ids,json=descriptorIds,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"descriptor_ids,omitempty"`
...
type DataDistributionResponse_TableInfo struct {
	ReplicaCountByNodeId map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64 `protobuf:"bytes,1,rep,name=replica_count_by_node_id,json=replicaCountByNodeId,proto3,castkey=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"replica_count_by_node_id,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
...
type EnqueueRangeRequest struct {
	...
	RangeID github_com_semistrict_ratel_pkg_roachpb.RangeID `protobuf:"varint,3,opt,name=range_id,json=rangeId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.RangeID" json:"range_id,omitempty"`
...
type GetTraceRequest struct {
	...
	SnapshotID    int64                                                          `protobuf:"varint,1,opt,name=snapshot_id,json=snapshotId,proto3" json:"snapshot_id,omitempty"`
	TraceID       github_com_semistrict_ratel_pkg_util_tracing_tracingpb.TraceID `protobuf:"varint,2,opt,name=trace_id,json=traceId,proto3,customtype=github.com/semistrict/ratel/pkg/util/tracing/tracingpb.TraceID" json:"trace_id"`
...
type SetTraceRecordingTypeRequest struct {
	...
	SpanID        github_com_semistrict_ratel_pkg_util_tracing_tracingpb.SpanID `protobuf:"varint,2,opt,name=span_id,json=spanId,proto3,customtype=github.com/semistrict/ratel/pkg/util/tracing/tracingpb.SpanID" json:"span_id"`
...
func init() {
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_roachpb.NodeID]livenesspb.NodeLivenessStatus)(nil), "cockroach.server.serverpb.LivenessResponse.StatusesEntry")
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64)(nil), "cockroach.server.serverpb.DataDistributionResponse.TableInfo.ReplicaCountByNodeIdEntry")
...
var fileDescriptor_0b2ccb6a0551fa7e = []byte{
	...
	,
}
...
func (m *LivenessResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Statuses) > 0 {
		...
		for iNdEx := len(keysForStatuses) - 1; iNdEx >= 0; iNdEx-- {
			v := m.Statuses[github_com_semistrict_ratel_pkg_roachpb.NodeID(keysForStatuses[iNdEx])]
			baseI := i
...
func (m *DataDistributionResponse_TableInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.ReplicaCountByNodeId) > 0 {
		...
		for iNdEx := len(keysForReplicaCountByNodeId) - 1; iNdEx >= 0; iNdEx-- {
			v := m.ReplicaCountByNodeId[github_com_semistrict_ratel_pkg_roachpb.NodeID(keysForReplicaCountByNodeId[iNdEx])]
			baseI := i
			i = encodeVarintAdmin(dAtA, i, uint64(v))
			i--
			dAtA[i] = 0x10
...
func (m *DatabaseDetailsResponse_Stats) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType == 0 {
				var v github_com_semistrict_ratel_pkg_roachpb.NodeID
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowAdmin
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.NodeIDs) == 0 {
					m.NodeIDs = make([]github_com_semistrict_ratel_pkg_roachpb.NodeID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_roachpb.NodeID
					for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReplicaID |= github_com_semistrict_ratel_pkg_roachpb.ReplicaID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *LivenessResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.Statuses == nil {
				m.Statuses = make(map[github_com_semistrict_ratel_pkg_roachpb.NodeID]livenesspb.NodeLivenessStatus)
			}
			var mapkey int32
			...
			m.Statuses[github_com_semistrict_ratel_pkg_roachpb.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAdmin(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.ReplicaCountByNodeId == nil {
				m.ReplicaCountByNodeId = make(map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64)
			}
			var mapkey int32
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.ReplicaCountByNodeId[github_com_semistrict_ratel_pkg_roachpb.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 2:
			if wireType != 0 {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SpanID |= github_com_semistrict_ratel_pkg_util_tracing_tracingpb.SpanID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
