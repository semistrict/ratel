...
type TxnMeta struct {
	...
	ID github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=id,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"id"`
...
type MVCCWriteIntentOp struct {
	TxnID           github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=txn_id,json=txnId,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"txn_id"`
...
var fileDescriptor_6599d13285d4d9cc = []byte{
	...
	,
}
...
func NewPopulatedTxnMeta(r randyMvcc3, easy bool) *TxnMeta {
	this := &TxnMeta{}
	v1 := github_com_semistrict_ratel_pkg_util_uuid.NewPopulatedUUID(r)
	this.ID = *v1
	v2 := r.Intn(100)
