...
// RowGroupDescriptor is the physical row-group metadata for a table row KV.
// For more information, look at `docs/tech-notes/encoding.md#value-encoding`.
type RowGroupDescriptor struct {
	Name string `protobuf:"bytes,1,opt,name=name" json:"name"`
	// Row-group 0 is *always* included in K/V pairs for a row. This makes sure
	// that rows with all NULL values still have a K/V pair.
	ID RowGroupID `protobuf:"varint,2,opt,name=id,casttype=RowGroupID" json:"id"`
	// A list of column names contained in the row-group. This list
	...
	// A list of column ids contained in the row-group. This list parallels
	...
	//
	// Row groups store columns in a ValueType_TUPLE as repeated <columnID><data>
...
func (m *RowGroupDescriptor) Reset()         { *m = RowGroupDescriptor{} }
func (m *RowGroupDescriptor) String() string { return proto.CompactTextString(m) }
func (*RowGroupDescriptor) ProtoMessage()    {}
func (*RowGroupDescriptor) Descriptor() ([]byte, []int) {
	return fileDescriptor_12dcc21c3bcc9571, []int{4}
}
func (m *RowGroupDescriptor) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *RowGroupDescriptor) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalToSizedBuffer(b)
	if err != nil {
		return nil, err
...
func (m *RowGroupDescriptor) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RowGroupDescriptor.Merge(m, src)
}
func (m *RowGroupDescriptor) XXX_Size() int {
	return m.Size()
}
func (m *RowGroupDescriptor) XXX_DiscardUnknown() {
	xxx_messageInfo_RowGroupDescriptor.DiscardUnknown(m)
}

var xxx_messageInfo_RowGroupDescriptor proto.InternalMessageInfo
...
type TableDescriptor struct {
	...
	// row_groups holds the physical row-group metadata for this table.
	// This list has exactly one entry in the current layout.
	// row_groups is stored in sorted order by ID.
	RowGroups []RowGroupDescriptor `protobuf:"bytes,22,rep,name=row_groups,json=rowGroups" json:"row_groups"`
	// next_row_group_id is used to ensure that deleted row-group ids are not reused.
	NextRowGroupID RowGroupID      `protobuf:"varint,23,opt,name=next_row_group_id,json=nextRowGroupId,casttype=RowGroupID" json:"next_row_group_id"`
...
func (m *TableDescriptor) GetRowGroups() []RowGroupDescriptor {
	if m != nil {
		return m.RowGroups
	}
	return nil
...
func (m *TableDescriptor) GetNextRowGroupID() RowGroupID {
	if m != nil {
		return m.NextRowGroupID
	}
	return 0
}
...
func init() {
	...
	proto.RegisterType((*RowGroupDescriptor)(nil), "cockroach.sql.sqlbase.RowGroupDescriptor")
...
var fileDescriptor_12dcc21c3bcc9571 = []byte{
	...
	,
}
...
func (this *RowGroupDescriptor) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*RowGroupDescriptor)
	if !ok {
		that2, ok := that.(RowGroupDescriptor)
		if ok {
			that1 = &that2
		} else {
			return false
...
func (this *TableDescriptor) Equal(that interface{}) bool {
	...
	if len(this.RowGroups) != len(that1.RowGroups) {
		return false
	}
	for i := range this.RowGroups {
		if !this.RowGroups[i].Equal(&that1.RowGroups[i]) {
			return false
		}
	}
	if this.NextRowGroupID != that1.NextRowGroupID {
		return false
	}
...
func (m *RowGroupDescriptor) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RowGroupDescriptor) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RowGroupDescriptor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TableDescriptor) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i--
	dAtA[i] = 0xc2
	i = encodeVarintStructured(dAtA, i, uint64(m.NextRowGroupID))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xb8
	if len(m.RowGroups) > 0 {
		for iNdEx := len(m.RowGroups) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.RowGroups[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *RowGroupDescriptor) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TableDescriptor) Size() (n int) {
	...
	n += 2 + sovStructured(uint64(m.NextRowGroupID))
	l = len(m.ViewQuery)
	n += 2 + l + sovStructured(uint64(l))
	if len(m.DependsOn) > 0 {
...
func (m *RowGroupDescriptor) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RowGroupDescriptor: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RowGroupDescriptor: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *TableDescriptor) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 22:
			...
			m.RowGroups = append(m.RowGroups, RowGroupDescriptor{})
			if err := m.RowGroups[len(m.RowGroups)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 23:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextRowGroupID", wireType)
			}
			m.NextRowGroupID = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.NextRowGroupID |= RowGroupID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
