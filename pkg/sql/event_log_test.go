...
func TestPerfLogging(t *testing.T) {
	...
	var testCases = []struct {
		...
		},
		{
			...
			errRe:       `row larger than max row size: table \d+ row group 0 primary key /Table/\d+/1/5/0 size \d+`,
		...
		},
		{
			...
			errRe:       `row larger than max row size: table \d+ row group 0 primary key /Table/\d+/1/2/0 size \d+`,
			logRe:       `"EventType":"large_row","RowSize":\d+,"TableID":\d+,"PrimaryKey":"‹/Table/\d+/1/2/0›"`,
			logExpected: true,
			channel:     channel.SQL_PERF,
		},
		...
		},
		{
			...
			errRe:       `pq: row larger than max row size: table \d+ row group 0 primary key /Table/\d+/1/2/0 size \d+`,
			logRe:       `"EventType":"large_row","RowSize":\d+,"TableID":\d+,"PrimaryKey":"‹/Table/\d+/1/2/0›"`,
			logExpected: true,
			channel:     channel.SQL_PERF,
		},
		...
		},
		{
			...
			errRe:       ``,
			logRe:       `"EventType":"large_row_internal","RowSize":\d+,"TableID":\d+,"PrimaryKey":"‹/Table/\d+/1/2/0›"`,
			logExpected: true,
			channel:     channel.SQL_INTERNAL_PERF,
		},
		{
		...
		},
		{
			...
			errRe:       `row larger than max row size: table \d+ row group 0 primary key /Table/\d+/1/3/0 size \d+`,
			logRe:       `"EventType":"large_row","RowSize":\d+,"TableID":\d+,"PrimaryKey":"‹/Table/\d+/1/3/0›"`,
			logExpected: true,
			channel:     channel.SQL_PERF,
		},
