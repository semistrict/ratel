...
type BackfillerSpec struct {
	...
	IndexesToBackfill []github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,8,rep,name=indexes_to_backfill,json=indexesToBackfill,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.IndexID" json:"indexes_to_backfill,omitempty"`
...
type JobProgress struct {
	JobID github_com_semistrict_ratel_pkg_jobs_jobspb.JobID `protobuf:"varint,1,opt,name=job_id,json=jobId,casttype=github.com/semistrict/ratel/pkg/jobs/jobspb.JobID" json:"job_id"`
...
type ReadImportDataSpec struct {
	...
	UserProto github_com_semistrict_ratel_pkg_security.SQLUsernameProto `protobuf:"bytes,15,opt,name=user_proto,json=userProto,casttype=github.com/semistrict/ratel/pkg/security.SQLUsernameProto" json:"user_proto"`
	...
	DatabasePrimaryRegion github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,17,opt,name=database_primary_region,json=databasePrimaryRegion,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.RegionName" json:"database_primary_region"`
...
type BackupDataSpec struct {
	...
	// when using FileTable ExternalStorage.
	UserProto github_com_semistrict_ratel_pkg_security.SQLUsernameProto `protobuf:"bytes,10,opt,name=user_proto,json=userProto,casttype=github.com/semistrict/ratel/pkg/security.SQLUsernameProto" json:"user_proto"`
}
...
type ExportSpec struct {
	...
	// when using FileTable ExternalStorage.
	UserProto github_com_semistrict_ratel_pkg_security.SQLUsernameProto `protobuf:"bytes,6,opt,name=user_proto,json=userProto,casttype=github.com/semistrict/ratel/pkg/security.SQLUsernameProto" json:"user_proto"`
...
type IndexBackfillMergerSpec struct {
	Table            descpb.TableDescriptor                                       `protobuf:"bytes,1,opt,name=table" json:"table"`
	TemporaryIndexes []github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,2,rep,name=temporary_indexes,json=temporaryIndexes,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.IndexID" json:"temporary_indexes,omitempty"`
	AddedIndexes     []github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,3,rep,name=added_indexes,json=addedIndexes,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.IndexID" json:"added_indexes,omitempty"`
...
var fileDescriptor_6d46d06b67eadaca = []byte{
	...
	,
}
		...
		case 8:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.IndexesToBackfill) == 0 {
					m.IndexesToBackfill = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID
					for shift := uint(0); ; shift += 7 {
		...
		case 2:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.TemporaryIndexes) == 0 {
					m.TemporaryIndexes = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID
					for shift := uint(0); ; shift += 7 {
		...
		case 3:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.AddedIndexes) == 0 {
					m.AddedIndexes = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID
					for shift := uint(0); ; shift += 7 {
