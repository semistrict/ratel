...
import (
	...
	github_com_semistrict_ratel_pkg_storage_enginepb "github.com/semistrict/ratel/pkg/storage/enginepb"
...
type StoreIdent struct {
	ClusterID github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"cluster_id"`
...
type MergeTrigger struct {
	...
	FreezeStart github_com_semistrict_ratel_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,5,opt,name=freeze_start,json=freezeStart,proto3,casttype=github.com/semistrict/ratel/pkg/util/hlc.ClockTimestamp" json:"freeze_start"`
...
type ObservedTimestamp struct {
	...
	Timestamp github_com_semistrict_ratel_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,2,opt,name=timestamp,proto3,casttype=github.com/semistrict/ratel/pkg/util/hlc.ClockTimestamp" json:"timestamp"`
}
...
type SequencedWrite struct {
	...
	Sequence github_com_semistrict_ratel_pkg_storage_enginepb.TxnSeq `protobuf:"varint,2,opt,name=sequence,proto3,casttype=github.com/semistrict/ratel/pkg/storage/enginepb.TxnSeq" json:"sequence,omitempty"`
}
...
type Lease struct {
	...
	Start github_com_semistrict_ratel_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,1,opt,name=start,proto3,casttype=github.com/semistrict/ratel/pkg/util/hlc.ClockTimestamp" json:"start"`
	...
	ProposedTS *github_com_semistrict_ratel_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,5,opt,name=proposed_ts,json=proposedTs,proto3,casttype=github.com/semistrict/ratel/pkg/util/hlc.ClockTimestamp" json:"proposed_ts,omitempty"`
...
type AbortSpanEntry struct {
	...
	Priority github_com_semistrict_ratel_pkg_storage_enginepb.TxnPriority `protobuf:"varint,3,opt,name=priority,proto3,casttype=github.com/semistrict/ratel/pkg/storage/enginepb.TxnPriority" json:"priority,omitempty"`
}
...
type LeafTxnInputState struct {
	...
	ReadSeqNum github_com_semistrict_ratel_pkg_storage_enginepb.TxnSeq `protobuf:"varint,10,opt,name=read_seq_num,json=readSeqNum,proto3,casttype=github.com/semistrict/ratel/pkg/storage/enginepb.TxnSeq" json:"read_seq_num,omitempty"`
}
...
var fileDescriptor_6493e3a32c32e46b = []byte{
	...
	,
}
...
func NewPopulatedObservedTimestamp(r randyData, easy bool) *ObservedTimestamp {
	...
	v3 := github_com_semistrict_ratel_pkg_util_hlc.NewPopulatedClockTimestamp(r, easy)
	this.Timestamp = *v3
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedSequencedWrite(r randyData, easy bool) *SequencedWrite {
	...
	this.Sequence = github_com_semistrict_ratel_pkg_storage_enginepb.TxnSeq(r.Int31())
	if r.Intn(2) == 0 {
		this.Sequence *= -1
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedLease(r randyData, easy bool) *Lease {
	this := &Lease{}
	v25 := github_com_semistrict_ratel_pkg_util_hlc.NewPopulatedClockTimestamp(r, easy)
	this.Start = *v25
	if r.Intn(5) != 0 {
	...
	if r.Intn(5) != 0 {
		this.ProposedTS = github_com_semistrict_ratel_pkg_util_hlc.NewPopulatedClockTimestamp(r, easy)
	}
...
func NewPopulatedAbortSpanEntry(r randyData, easy bool) *AbortSpanEntry {
	...
	this.Timestamp = *v28
	this.Priority = github_com_semistrict_ratel_pkg_storage_enginepb.TxnPriority(r.Int31())
	if r.Intn(2) == 0 {
		this.Priority *= -1
	}
	if !easy && r.Intn(10) != 0 {
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Sequence |= github_com_semistrict_ratel_pkg_storage_enginepb.TxnSeq(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Lease) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 5:
			...
			if m.ProposedTS == nil {
				m.ProposedTS = &github_com_semistrict_ratel_pkg_util_hlc.ClockTimestamp{}
			}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Priority |= github_com_semistrict_ratel_pkg_storage_enginepb.TxnPriority(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 10:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadSeqNum |= github_com_semistrict_ratel_pkg_storage_enginepb.TxnSeq(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
