...
import (
	...
	github_com_semistrict_ratel_pkg_base "github.com/semistrict/ratel/pkg/base"
	...
	github_com_semistrict_ratel_pkg_sql_catalog_catpb "github.com/semistrict/ratel/pkg/sql/catalog/catpb"
	...
	github_com_semistrict_ratel_pkg_sql_sem_tree "github.com/semistrict/ratel/pkg/sql/sem/tree"
...
type StreamReplicationDetails struct {
	...
	ProtectedTimestampRecord *github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,2,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
}
...
type SchedulePTSChainingRecord struct {
	ProtectedTimestampRecord *github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
...
type BackupDetails struct {
	...
	ProtectedTimestampRecord *github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,7,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
	...
	ResolvedCompleteDbs []github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,18,rep,packed,name=resolved_complete_dbs,json=resolvedCompleteDbs,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"resolved_complete_dbs,omitempty"`
...
type DescriptorRewrite struct {
	ID             github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,1,opt,name=id,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"id,omitempty"`
	ParentID       github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,2,opt,name=parent_id,json=parentId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"parent_id,omitempty"`
	ParentSchemaID github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,5,opt,name=parent_schema_id,json=parentSchemaId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"parent_schema_id,omitempty"`
...
type RestoreDetails struct {
	...
	DescriptorRewrites map[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID]*DescriptorRewrite `protobuf:"bytes,2,rep,name=descriptor_rewrites,json=descriptorRewrites,proto3,castkey=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"descriptor_rewrites,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	...
	DescriptorCoverage   github_com_semistrict_ratel_pkg_sql_sem_tree.DescriptorCoverage `protobuf:"varint,11,opt,name=descriptor_coverage,json=descriptorCoverage,proto3,casttype=github.com/semistrict/ratel/pkg/sql/sem/tree.DescriptorCoverage" json:"descriptor_coverage,omitempty"`
...
type RestoreDetails_RevalidateIndex struct {
	TableID github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID      `protobuf:"varint,1,opt,name=id,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"id,omitempty"`
	IndexID github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,2,opt,name=parent_id,json=parentId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.IndexID" json:"parent_id,omitempty"`
}
...
type ImportDetails struct {
	...
	ParentID   github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,6,opt,name=parent_id,json=parentId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"parent_id,omitempty"`
	...
	// does not run the code to do so. To deal with this there is a background
	// reconciliation loop to ensure that protected timestamps are cleaned up.
	ProtectedTimestampRecord *github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,22,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"protected_timestamp_record,omitempty"`
	...
	DatabasePrimaryRegion github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,27,opt,name=database_primary_region,json=databasePrimaryRegion,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.RegionName" json:"database_primary_region,omitempty"`
}
...
type TypeSchemaChangeDetails struct {
	TypeID github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,1,opt,name=type_id,json=typeId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"type_id,omitempty"`
...
type BackfillProgress struct {
	...
	// a merge.
	SourceIndexID github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,2,opt,name=source_index_id,json=sourceIndexId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.IndexID" json:"source_index_id,omitempty"`
	// DestIndexIDs is the set of IDs which are being backfilled from the
	// SourceIndexID.
	DestIndexIDs []github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,3,rep,packed,name=dest_index_ids,json=destIndexIds,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.IndexID" json:"dest_index_ids,omitempty"`
...
type DroppedTableDetails struct {
	...
	ID     github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,2,opt,name=ID,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"ID,omitempty"`
...
type SchemaChangeGCDetails struct {
	...
	ParentID github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,3,opt,name=parent_id,json=parentId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"parent_id,omitempty"`
	// Tenant to GC.
...
type SchemaChangeGCDetails_DroppedIndex struct {
	IndexID  github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID `protobuf:"varint,1,opt,name=index_id,json=indexId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.IndexID" json:"index_id,omitempty"`
...
type SchemaChangeDetails struct {
	...
	DroppedTypes []github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,8,rep,packed,name=dropped_types,json=droppedTypes,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"dropped_types,omitempty"`
	// dropped_schemas holds the set of schemas to drop as part of a DROP SCHEMA
	// or DROP DATABASE cascade statement.
	DroppedSchemas []github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,9,rep,packed,name=dropped_schemas,json=droppedSchemas,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"dropped_schemas,omitempty"`
	// The descriptor ID of the dropped database which created this job.
	DroppedDatabaseID github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,4,opt,name=dropped_database_id,json=droppedDatabaseId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"dropped_database_id,omitempty"`
	...
	DescID github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,5,opt,name=desc_id,json=descId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"desc_id,omitempty"`
	...
	TableMutationID github_com_semistrict_ratel_pkg_sql_catalog_descpb.MutationID `protobuf:"varint,6,opt,name=table_mutation_id,json=tableMutationId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.MutationID" json:"table_mutation_id,omitempty"`
...
type ChangefeedTargetSpecification struct {
	...
	TableID           github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,2,opt,name=table_id,json=tableId,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"table_id,omitempty"`
...
type ChangefeedProgress struct {
	...
	ProtectedTimestampRecord github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,3,opt,name=protected_timestamp_record,json=protectedTimestampRecord,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"protected_timestamp_record"`
}
...
type CreateStatsDetails_ColStat struct {
	ColumnIDs []github_com_semistrict_ratel_pkg_sql_catalog_descpb.ColumnID `protobuf:"varint,1,rep,packed,name=column_ids,json=columnIds,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ColumnID" json:"column_ids,omitempty"`
...
type Payload struct {
	...
	UsernameProto github_com_semistrict_ratel_pkg_security.SQLUsernameProto `protobuf:"bytes,2,opt,name=username_proto,json=usernameProto,proto3,casttype=github.com/semistrict/ratel/pkg/security.SQLUsernameProto" json:"username_proto,omitempty"`
	...
	DescriptorIDs  []github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID `protobuf:"varint,6,rep,packed,name=descriptor_ids,json=descriptorIds,proto3,casttype=github.com/semistrict/ratel/pkg/sql/catalog/descpb.ID" json:"descriptor_ids,omitempty"`
	...
	CreationClusterID github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,35,opt,name=creation_cluster_id,json=creationClusterId,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"creation_cluster_id"`
...
type Progress struct {
	...
	TraceID github_com_semistrict_ratel_pkg_util_tracing_tracingpb.TraceID `protobuf:"varint,21,opt,name=trace_id,json=traceId,proto3,customtype=github.com/semistrict/ratel/pkg/util/tracing/tracingpb.TraceID" json:"trace_id"`
}
...
type RetriableExecutionFailure struct {
	...
	InstanceID github_com_semistrict_ratel_pkg_base.SQLInstanceID `protobuf:"varint,4,opt,name=instance_id,json=instanceId,proto3,customtype=github.com/semistrict/ratel/pkg/base.SQLInstanceID" json:"instance_id"`
...
func init() {
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID]*RestoreDetails_DatabaseModifier)(nil), "cockroach.sql.jobs.jobspb.RestoreDetails.DatabaseModifiersEntry")
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID]*DescriptorRewrite)(nil), "cockroach.sql.jobs.jobspb.RestoreDetails.DescriptorRewritesEntry")
...
var fileDescriptor_6c315f3a2536c4ef = []byte{
	...
	,
}
...
func (m *RestoreDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.DatabaseModifiers) > 0 {
		...
		for iNdEx := len(keysForDatabaseModifiers) - 1; iNdEx >= 0; iNdEx-- {
			v := m.DatabaseModifiers[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(keysForDatabaseModifiers[iNdEx])]
			baseI := i
			if v != nil {
				{
					size, err := v.MarshalToSizedBuffer(dAtA[:i])
	...
	if len(m.DescriptorRewrites) > 0 {
		...
		for iNdEx := len(keysForDescriptorRewrites) - 1; iNdEx >= 0; iNdEx-- {
			v := m.DescriptorRewrites[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(keysForDescriptorRewrites[iNdEx])]
			baseI := i
			if v != nil {
				{
					size, err := v.MarshalToSizedBuffer(dAtA[:i])
...
func (m *ChangefeedDetails) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Tables) > 0 {
		...
		for iNdEx := len(keysForTables) - 1; iNdEx >= 0; iNdEx-- {
			v := m.Tables[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(keysForTables[iNdEx])]
			baseI := i
			{
				size, err := (&v).MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
...
func (m *StreamReplicationDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			var v github_com_semistrict_ratel_pkg_util_uuid.UUID
...
func (m *BackupDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 18:
			if wireType == 0 {
				var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowJobs
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.ResolvedCompleteDbs) == 0 {
					m.ResolvedCompleteDbs = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID
					for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ParentID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ParentSchemaID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			if m.DescriptorRewrites == nil {
				m.DescriptorRewrites = make(map[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID]*DescriptorRewrite)
			}
			var mapkey uint32
			...
			m.DescriptorRewrites[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
		...
		case 11:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DescriptorCoverage |= github_com_semistrict_ratel_pkg_sql_sem_tree.DescriptorCoverage(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 19:
			...
			if m.DatabaseModifiers == nil {
				m.DatabaseModifiers = make(map[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID]*RestoreDetails_DatabaseModifier)
			}
			var mapkey uint32
			...
			m.DatabaseModifiers[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 20:
			if wireType != 2 {
...
func (m *ImportDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 27:
			...
			m.DatabasePrimaryRegion = github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipJobs(dAtA[iNdEx:])
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TypeID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SourceIndexID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			if wireType == 0 {
				var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
						return ErrIntOverflowJobs
					}
					...
					b := dAtA[iNdEx]
					iNdEx++
					v |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID(b&0x7F) << shift
					if b < 0x80 {
						break
					}
				}
				...
				if elementCount != 0 && len(m.DestIndexIDs) == 0 {
					m.DestIndexIDs = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.IndexID
					for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DroppedDatabaseID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DescID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TableMutationID |= github_com_semistrict_ratel_pkg_sql_catalog_descpb.MutationID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 8:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.DroppedTypes) == 0 {
					m.DroppedTypes = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID
					for shift := uint(0); ; shift += 7 {
		...
		case 9:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.DroppedSchemas) == 0 {
					m.DroppedSchemas = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID
					for shift := uint(0); ; shift += 7 {
...
func (m *ChangefeedDetails) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			m.Tables[github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID(mapkey)] = *mapvalue
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
...
func (m *Payload) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.UsernameProto = github_com_semistrict_ratel_pkg_security.SQLUsernameProto(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 0 {
		...
		case 6:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.DescriptorIDs) == 0 {
					m.DescriptorIDs = make([]github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_semistrict_ratel_pkg_sql_catalog_descpb.ID
					for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InstanceID |= github_com_semistrict_ratel_pkg_base.SQLInstanceID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
