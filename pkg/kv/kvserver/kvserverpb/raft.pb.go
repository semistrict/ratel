...
type RaftHeartbeat struct {
	RangeID                   github_com_semistrict_ratel_pkg_roachpb.RangeID   `protobuf:"varint,1,opt,name=range_id,json=rangeId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.RangeID" json:"range_id,omitempty"`
	FromReplicaID             github_com_semistrict_ratel_pkg_roachpb.ReplicaID `protobuf:"varint,2,opt,name=from_replica_id,json=fromReplicaId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.ReplicaID" json:"from_replica_id,omitempty"`
	ToReplicaID               github_com_semistrict_ratel_pkg_roachpb.ReplicaID `protobuf:"varint,3,opt,name=to_replica_id,json=toReplicaId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.ReplicaID" json:"to_replica_id,omitempty"`
...
type RaftMessageRequest struct {
	...
	RangeStartKey github_com_semistrict_ratel_pkg_roachpb.RKey `protobuf:"bytes,8,opt,name=range_start_key,json=rangeStartKey,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.RKey" json:"range_start_key,omitempty"`
...
var fileDescriptor_755441ac72dfaa3b = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FromReplicaID |= github_com_semistrict_ratel_pkg_roachpb.ReplicaID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ToReplicaID |= github_com_semistrict_ratel_pkg_roachpb.ReplicaID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
