...
type Request struct {
	...
	HighWaterStamps map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64 `protobuf:"bytes,3,rep,name=high_water_stamps,json=highWaterStamps,proto3,castkey=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"high_water_stamps" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	...
	ClusterID github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"cluster_id"`
}
...
type Response struct {
	...
	AlternateNodeID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,4,opt,name=alternate_node_id,json=alternateNodeId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"alternate_node_id,omitempty"`
	...
	HighWaterStamps map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64 `protobuf:"bytes,6,rep,name=high_water_stamps,json=highWaterStamps,proto3,castkey=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"high_water_stamps" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
type Connectivity struct {
	SentinelNodeID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=sentinel_node_id,json=sentinelNodeId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"sentinel_node_id,omitempty"`
...
type Connectivity_Conn struct {
	SourceID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=source_id,json=sourceId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"source_id,omitempty"`
	TargetID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,2,opt,name=target_id,json=targetId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"target_id,omitempty"`
}
...
type Info struct {
	...
	NodeID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,5,opt,name=node_id,json=nodeId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"node_id,omitempty"`
	// Peer node ID which passed this info.
	PeerID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,6,opt,name=peer_id,json=peerId,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"peer_id,omitempty"`
}
...
func init() {
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64)(nil), "cockroach.gossip.Request.HighWaterStampsEntry")
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64)(nil), "cockroach.gossip.Response.HighWaterStampsEntry")
...
var fileDescriptor_c8c862cd799681d0 = []byte{
	...
	,
}
...
func (m *Request) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.HighWaterStamps) > 0 {
		...
		for iNdEx := len(keysForHighWaterStamps) - 1; iNdEx >= 0; iNdEx-- {
			v := m.HighWaterStamps[github_com_semistrict_ratel_pkg_roachpb.NodeID(keysForHighWaterStamps[iNdEx])]
			baseI := i
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.HighWaterStamps == nil {
				m.HighWaterStamps = make(map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64)
			}
			var mapkey int32
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.HighWaterStamps[github_com_semistrict_ratel_pkg_roachpb.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AlternateNodeID |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SentinelNodeID |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SourceID |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetID |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PeerID |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
