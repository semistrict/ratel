...
type NodeStatus struct {
	...
	Latencies map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64 `protobuf:"bytes,9,rep,name=latencies,proto3,castkey=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"latencies" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	// activity is a map of nodeIDs to network statistics from this node
	// to other nodes.
	Activity map[github_com_semistrict_ratel_pkg_roachpb.NodeID]NodeStatus_NetworkActivity `protobuf:"bytes,10,rep,name=activity,proto3,castkey=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"activity" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
...
type HealthAlert struct {
	...
	StoreID     github_com_semistrict_ratel_pkg_roachpb.StoreID `protobuf:"varint,1,opt,name=store_id,json=storeId,proto3,customtype=github.com/semistrict/ratel/pkg/roachpb.StoreID" json:"store_id"`
...
func init() {
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_roachpb.NodeID]NodeStatus_NetworkActivity)(nil), "cockroach.server.status.statuspb.NodeStatus.ActivityEntry")
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64)(nil), "cockroach.server.status.statuspb.NodeStatus.LatenciesEntry")
...
var fileDescriptor_7866944fdf22d33b = []byte{
	...
	,
}
...
func (m *NodeStatus) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Activity) > 0 {
		...
		for iNdEx := len(keysForActivity) - 1; iNdEx >= 0; iNdEx-- {
			v := m.Activity[github_com_semistrict_ratel_pkg_roachpb.NodeID(keysForActivity[iNdEx])]
			baseI := i
			{
	...
	if len(m.Latencies) > 0 {
		...
		for iNdEx := len(keysForLatencies) - 1; iNdEx >= 0; iNdEx-- {
			v := m.Latencies[github_com_semistrict_ratel_pkg_roachpb.NodeID(keysForLatencies[iNdEx])]
			baseI := i
...
func (m *NodeStatus) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			...
			if m.Latencies == nil {
				m.Latencies = make(map[github_com_semistrict_ratel_pkg_roachpb.NodeID]int64)
			}
			var mapkey int32
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.Latencies[github_com_semistrict_ratel_pkg_roachpb.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 10:
			if wireType != 2 {
			...
			if m.Activity == nil {
				m.Activity = make(map[github_com_semistrict_ratel_pkg_roachpb.NodeID]NodeStatus_NetworkActivity)
			}
			var mapkey int32
			...
			m.Activity[github_com_semistrict_ratel_pkg_roachpb.NodeID(mapkey)] = *mapvalue
			iNdEx = postIndex
		case 11:
			if wireType != 0 {
