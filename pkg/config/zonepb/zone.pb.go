...
type SubzoneSpan struct {
	...
	Key github_com_semistrict_ratel_pkg_roachpb.Key `protobuf:"bytes,1,opt,name=key,casttype=github.com/semistrict/ratel/pkg/roachpb.Key" json:"key,omitempty"`
	...
	EndKey github_com_semistrict_ratel_pkg_roachpb.Key `protobuf:"bytes,2,opt,name=end_key,json=endKey,casttype=github.com/semistrict/ratel/pkg/roachpb.Key" json:"end_key,omitempty"`
...
var fileDescriptor_450fc84cee6c50bb = []byte{
	...
	,
}
...
func NewPopulatedSubzoneSpan(r randyZone, easy bool) *SubzoneSpan {
	...
	if r.Intn(5) != 0 {
		v21 := r.Intn(100)
		this.Key = make(github_com_semistrict_ratel_pkg_roachpb.Key, v21)
		for i := 0; i < v21; i++ {
	...
	if r.Intn(5) != 0 {
		v22 := r.Intn(100)
		this.EndKey = make(github_com_semistrict_ratel_pkg_roachpb.Key, v22)
		for i := 0; i < v22; i++ {
