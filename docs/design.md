...
implementation is [here](https://github.com/semistrict/ratel/blob/master/pkg/util/hlc/hlc.go).
...
Please see [pkg/roachpb/data.proto](https://github.com/semistrict/ratel/blob/master/pkg/roachpb/data.proto) for the up-to-date structures, the best entry point being `message Transaction`.
...
Please see
[pkg/config/zone.proto](https://github.com/semistrict/ratel/blob/master/pkg/config/zone.proto)
