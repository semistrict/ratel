...
// https://github.com/semistrict/ratel/blob/master/docs/RFCS/20160425_drain_modes.md
//
...
func (s *Server) ServeConn(ctx context.Context, conn net.Conn, socketType SocketType) (err error) {
	...
	case versionGSSENC:
		...
		// https://github.com/semistrict/ratel/issues/52184
		//
...
func (s *Server) maybeUpgradeToSecureConn(
	...
	if version != versionSSL {
		...
		// https://github.com/semistrict/ratel/issues/53404
		if s.cfg.Insecure {
			return
		}
