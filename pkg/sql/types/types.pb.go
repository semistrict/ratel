...
import (
	...
	geopb "github.com/semistrict/ratel/pkg/geo/geopb"
	github_com_semistrict_ratel_pkg_geo_geopb "github.com/semistrict/ratel/pkg/geo/geopb"
	io "io"
	math "math"
	math_bits "math/bits"
)
...
type GeoMetadata struct {
	SRID      github_com_semistrict_ratel_pkg_geo_geopb.SRID `protobuf:"varint,1,opt,name=srid,casttype=github.com/semistrict/ratel/pkg/geo/geopb.SRID" json:"srid"`
...
var fileDescriptor_bc7f16796a7f6725 = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SRID |= github_com_semistrict_ratel_pkg_geo_geopb.SRID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
