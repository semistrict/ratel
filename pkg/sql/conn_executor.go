...
import (
	...
	"github.com/semistrict/ratel/pkg/sql/contention/txnidcache"
	"github.com/semistrict/ratel/pkg/sql/execstats"
	"github.com/semistrict/ratel/pkg/sql/idxusage"
		...
		handleErr := func(err error) {
			if implicitTxn {
				...
				newErr = errors.WithIssueLink(newErr,
					errors.IssueLink{IssueURL: "https://github.com/semistrict/ratel/issues/42061"})
				res.SetError(newErr)
			}
		}
