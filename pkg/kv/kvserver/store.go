...
import (
	...
	"github.com/semistrict/ratel/pkg/kv/kvserver/idalloc"
	...
	"github.com/semistrict/ratel/pkg/kv/kvserver/rangefeed"
	"github.com/semistrict/ratel/pkg/kv/kvserver/tenantrate"
	"github.com/semistrict/ratel/pkg/kv/kvserver/tscache"
	"github.com/semistrict/ratel/pkg/kv/kvserver/txnrecovery"
	...
	"github.com/semistrict/ratel/pkg/util/limit"
	...
	"github.com/semistrict/ratel/pkg/util/shuffle"
...
func (s *Store) SetDraining(drain bool, reporter func(int, redact.SafeString), verbose bool) {
	...
	if err := contextutil.RunWithTimeout(ctx, drainLeasesOp, transferTimeout,
		func(ctx context.Context) error {
			...
			var err error
			// Avoid retry.ForDuration because of https://github.com/semistrict/ratel/issues/25091.
...
func (s *Store) Enqueue(
	...
	if async {
		...
		// https://github.com/semistrict/ratel/issues/79266, we can consider
