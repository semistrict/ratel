...
Upload alert rules:
*  These are copied from https://github.com/semistrict/ratel/blob/master/monitoring/rules/alerts.rules.yml:
...
```
go get github.com/semistrict/ratel/pkg/cmd/wraprules
