...
type TableReaderSpec struct {
	...
	// ActorName selects the actor whose table data should be accessed by this
	// table reader. If empty, the session actor scope applies. The spans in
	// this spec are already built with the actor-scoped prefix; this field is
	// carried for consistency with other processor specs and for observability.
	ActorName string `protobuf:"bytes,23,opt,name=actor_name,json=actorName" json:"actor_name"`
}
...
type JoinReaderSpec struct {
	...
	// ActorName selects the actor whose table data should be accessed for this
	// join reader. If empty, the session actor scope applies.
	ActorName string `protobuf:"bytes,20,opt,name=actor_name,json=actorName" json:"actor_name"`
...
type ZigzagJoinerSpec struct {
	...
	Type        descpb.JoinType   `protobuf:"varint,6,opt,name=type,enum=cockroach.sql.sqlbase.JoinType" json:"type"`
	// ActorName selects the actor whose table data should be accessed by this
	// zigzag joiner. If empty, the session actor scope applies.
	ActorName string `protobuf:"bytes,7,opt,name=actor_name,json=actorName" json:"actor_name"`
}
...
type InvertedJoinerSpec struct {
	...
	// ActorName selects the actor whose table data should be accessed by this
	// inverted joiner. If empty, the session actor scope applies.
	ActorName string `protobuf:"bytes,10,opt,name=actor_name,json=actorName" json:"actor_name"`
}
...
var fileDescriptor_90493aed97b6d28f = []byte{
	...
	,
}
...
func (m *TableReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	i = encodeVarintProcessorsSql(dAtA, i, uint64(len(m.ActorName)))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0xba
...
func (m *JoinReaderSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		dAtA12 := make([]byte, len(m.LookupColumns)*10)
		var j11 int
...
func (m *ZigzagJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IndexOrdinals) > 0 {
		dAtA17 := make([]byte, len(m.IndexOrdinals)*10)
		var j16 int
...
func (m *HashJoinerSpec) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RightEqColumns) > 0 {
		dAtA23 := make([]byte, len(m.RightEqColumns)*10)
		var j22 int
...
func (m *TableReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ActorName", wireType)
			}
			...
			m.ActorName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipProcessorsSql(dAtA[iNdEx:])
