...
func TestPost(t *testing.T) {
	...
	testCases := []testCase{
		{
			name:        "failure",
			packageName: "github.com/semistrict/ratel/pkg/storage",
...
`,
		...
		{
			name:        "rsg-crash",
			packageName: "github.com/semistrict/ratel/pkg/sql/tests",
...
test logs left over in: /go/src/github.com/semistrict/ratel/artifacts/logTestRandomSyntaxSQLSmith460792454
...
`,
		...
		},
		{
			...
			packageName: "github.com/semistrict/ratel/pkg/cmd/roachtest",
			testName:    "some-roachtest",
			message:     "boom",
			reproURL:    "https://github.com/semistrict/ratel",
...
func TestPostEndToEnd(t *testing.T) {
	...
	req := PostRequest{
		PackageName: "github.com/semistrict/ratel/pkg/foo/bar",
...
func ghURL(t *testing.T, title, body string) string {
	u, err := url.Parse("https://github.com/semistrict/ratel/issues/new")
