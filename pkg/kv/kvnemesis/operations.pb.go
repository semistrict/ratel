...
type TransferLeaseOperation struct {
	Key    []byte                                          `protobuf:"bytes,1,opt,name=key,proto3" json:"key,omitempty"`
	Target github_com_semistrict_ratel_pkg_roachpb.StoreID `protobuf:"varint,2,opt,name=target,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.StoreID" json:"target,omitempty"`
	Result Result                                          `protobuf:"bytes,3,opt,name=result,proto3" json:"result"`
}
...
var fileDescriptor_6874d5f7dae1c75d = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Target |= github_com_semistrict_ratel_pkg_roachpb.StoreID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
