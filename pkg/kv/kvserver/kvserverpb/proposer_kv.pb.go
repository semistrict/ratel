...
type ComputeChecksum struct {
	...
	ChecksumID github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=checksum_id,json=checksumId,proto3,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"checksum_id"`
...
type SuggestedCompaction struct {
	StartKey   github_com_semistrict_ratel_pkg_roachpb.Key `protobuf:"bytes,1,opt,name=start_key,json=startKey,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.Key" json:"start_key,omitempty"`
	EndKey     github_com_semistrict_ratel_pkg_roachpb.Key `protobuf:"bytes,2,opt,name=end_key,json=endKey,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.Key" json:"end_key,omitempty"`
...
type ReplicatedEvalResult struct {
	...
	PrevLeaseProposal *github_com_semistrict_ratel_pkg_util_hlc.ClockTimestamp `protobuf:"bytes,20,opt,name=prev_lease_proposal,json=prevLeaseProposal,proto3,casttype=github.com/semistrict/ratel/pkg/util/hlc.ClockTimestamp" json:"prev_lease_proposal,omitempty"`
...
type RaftCommand struct {
	...
	ProposerLeaseSequence github_com_semistrict_ratel_pkg_roachpb.LeaseSequence `protobuf:"varint,6,opt,name=proposer_lease_sequence,json=proposerLeaseSequence,proto3,casttype=github.com/semistrict/ratel/pkg/roachpb.LeaseSequence" json:"proposer_lease_sequence,omitempty"`
...
var fileDescriptor_19df0b186dd19269 = []byte{
	...
	,
}
...
func (m *ReplicatedEvalResult) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 20:
			...
			if m.PrevLeaseProposal == nil {
				m.PrevLeaseProposal = &github_com_semistrict_ratel_pkg_util_hlc.ClockTimestamp{}
			}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProposerLeaseSequence |= github_com_semistrict_ratel_pkg_roachpb.LeaseSequence(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
