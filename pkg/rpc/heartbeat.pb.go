...
type PingRequest struct {
	...
	ClusterID     *github_com_semistrict_ratel_pkg_util_uuid.UUID `protobuf:"bytes,5,opt,name=origin_cluster_id,json=originClusterId,customtype=github.com/semistrict/ratel/pkg/util/uuid.UUID" json:"origin_cluster_id,omitempty"`
	...
	TargetNodeID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,7,opt,name=target_node_id,json=targetNodeId,customtype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"target_node_id"`
	// NodeID of the originator of the PingRequest.
	OriginNodeID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,8,opt,name=origin_node_id,json=originNodeId,customtype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"origin_node_id"`
}
...
var fileDescriptor_83e673eca80fa32b = []byte{
	...
	,
}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetNodeID |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OriginNodeID |= github_com_semistrict_ratel_pkg_roachpb.NodeID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
