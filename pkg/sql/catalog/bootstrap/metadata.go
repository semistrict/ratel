...
func addSystemDescriptorsToSchema(target *MetadataSchema) {
	...
	target.AddDescriptor(systemschema.WorkerVersionsTable)
	target.AddDescriptor(systemschema.WorkerAssetsTable)
	target.AddDescriptor(systemschema.WorkerVersionAssetsTable)
