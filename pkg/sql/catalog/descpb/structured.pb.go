...
type TableDescriptor struct {
	...
	DropJobID github_com_semistrict_ratel_pkg_sql_catalog_catpb.JobID `protobuf:"varint,32,opt,name=drop_job_id,json=dropJobId,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.JobID" json:"drop_job_id"`
	// Before 22.1:
...
func (m *TableDescriptor) GetDropJobID() github_com_semistrict_ratel_pkg_sql_catalog_catpb.JobID {
	if m != nil {
		return m.DropJobID
	}
	return 0
...
type TableDescriptor_SchemaChangeLease struct {
	NodeID github_com_semistrict_ratel_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=node_id,json=nodeId,casttype=github.com/semistrict/ratel/pkg/roachpb.NodeID" json:"node_id"`
...
type TableDescriptor_MutationJob struct {
	...
	JobID github_com_semistrict_ratel_pkg_sql_catalog_catpb.JobID `protobuf:"varint,2,opt,name=job_id,json=jobId,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.JobID" json:"job_id"`
}
...
type TableDescriptor_GCDescriptorMutation struct {
	...
	// The job id for a mutation job is the id in the system.jobs table of the
	// schema change job executing the mutation referenced by mutation_id.
	JobID github_com_semistrict_ratel_pkg_sql_catalog_catpb.JobID `protobuf:"varint,3,opt,name=job_id,json=jobId,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.JobID" json:"job_id"` // Deprecated: Do not use.
}
...
type DatabaseDescriptor_RegionConfig struct {
	...
	PrimaryRegion github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,3,opt,name=primary_region,json=primaryRegion,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.RegionName" json:"primary_region"`
...
type SuperRegion struct {
	...
	Regions         []github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,2,rep,name=regions,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.RegionName" json:"regions,omitempty"`
}
...
type ZoneConfigExtensions struct {
	...
	RegionalIn map[github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName]zonepb.ZoneConfig `protobuf:"bytes,3,rep,name=regional_in,json=regionalIn,castkey=github.com/semistrict/ratel/pkg/sql/catalog/catpb.RegionName" json:"regional_in" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
type TypeDescriptor_RegionConfig struct {
	...
	PrimaryRegion github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName `protobuf:"bytes,1,opt,name=primary_region,json=primaryRegion,casttype=github.com/semistrict/ratel/pkg/sql/catalog/catpb.RegionName" json:"primary_region"`
...
func init() {
	...
	proto.RegisterMapType((map[github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName]zonepb.ZoneConfig)(nil), "cockroach.sql.sqlbase.ZoneConfigExtensions.RegionalInEntry")
...
var fileDescriptor_12dcc21c3bcc9571 = []byte{
	...
	,
}
...
func (m *ZoneConfigExtensions) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RegionalIn) > 0 {
		...
		for iNdEx := len(keysForRegionalIn) - 1; iNdEx >= 0; iNdEx-- {
			v := m.RegionalIn[github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName(keysForRegionalIn[iNdEx])]
			baseI := i
			{
				size, err := (&v).MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
	...
	for iNdEx < l {
		...
		case 32:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.DropJobID |= github_com_semistrict_ratel_pkg_sql_catalog_catpb.JobID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.JobID |= github_com_semistrict_ratel_pkg_sql_catalog_catpb.JobID(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *DatabaseDescriptor_RegionConfig) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.PrimaryRegion = github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 4:
			if wireType != 0 {
...
func (m *SuperRegion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Regions = append(m.Regions, github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipStructured(dAtA[iNdEx:])
...
func (m *ZoneConfigExtensions) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.RegionalIn == nil {
				m.RegionalIn = make(map[github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName]zonepb.ZoneConfig)
			}
			var mapkey github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName
			...
			for iNdEx < postIndex {
				...
				if fieldNum == 1 {
					...
					mapkey = github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName(dAtA[iNdEx:postStringIndexmapkey])
					iNdEx = postStringIndexmapkey
				} else if fieldNum == 2 {
					var mapmsglen int
					for shift := uint(0); ; shift += 7 {
			...
			m.RegionalIn[github_com_semistrict_ratel_pkg_sql_catalog_catpb.RegionName(mapkey)] = *mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipStructured(dAtA[iNdEx:])
